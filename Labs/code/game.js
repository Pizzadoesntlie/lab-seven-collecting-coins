...
// coin
function Coin(pos) {
	this.basePos = this.pos = pos.plus(new Vector(0.5,1));
...
Level.prototype.actorAt = function(actor) {
	for (var i = 0; i < this.actors.length; i++) {
		...
		// actor size overlapping where the other begins and is it inside the box where the other ends
		// actor collisions
		if (other != actor && 
...
//removes thing we dont want anymore
